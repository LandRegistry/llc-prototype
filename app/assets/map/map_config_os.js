...
/*     MAP_CONFIG.base_layer_zindex = 0;
    ...
    MAP_CONFIG.mastermapResolutions =  [ 896.0, 448.0, 224.0, 112.0, 56.0, 28.0, 14.0, 7.0, 3.5, 1.75, 0.875, 0.4375, 0.21875, 0.109375 ];
...
MAP_CONFIG.createBaseLayer = function (zIndex, res, proj, osTermsLink, maintenance) {
    ...
    return new ol.layer.Tile({
      source: new ol.source.XYZ({
          url: 'https://api.os.uk/maps/raster/v1/zxy/Light_27700/{z}/{x}/{y}.png?key=' + os_api_key,
